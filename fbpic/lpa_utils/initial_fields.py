...
def add_initial_B_field_m_0(sim, Br, Bt, Bz):
    ...
    # Save previous values on the grid, and replace them with the
    # magnetic fields (This is done in preparation for gathering
    # among procs)
    ...
    for field in ["Br", "Bt", "Bz"]:
        ...
        local_array = sim.comm.scatter_grid_array(global_array, with_damp=True)
